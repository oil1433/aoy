...
settings = {
    ...
    "responcall": False,
    "responcallgc": False,
    "restartPoint": "ucf9143c21a35bffd9beba922b7cc4042",
    "server": "VPS",
    "ksticker": False,
    "userMentioned": False,
    "timeRestart": "18000",
...
#==============================================================================#
                ...
                if text.lower() == 'help':
                    ...
                    name = "คำสั่งบอท"                   
                    link = "http://line.me/ti/p/~aoy1433."
                    myHelp = myhelp()
                    line.sendFooter(to, str(myHelp),link ,icon,name)
                    line.sendMentionFooter(to, '「ผู้ควบคุมบอท」\n', sender, "https://line.me/ti/p/~aoy1433.", "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, line.getContact(sender).displayName);line.sendMessage(to, line.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+line.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~aoy1433.', 'type': 'mt', 'subText': "AOYBOTLINE", 'a-installUrl': 'https://line.me/ti/p/~aoy1433.', 'a-installUrl': ' https://line.me/ti/p/~aoy1433.', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~aoy1433.', 'i-linkUri': 'https://line.me/ti/p/~aoy1433.', 'id': 'mt000000000a6b79f9', 'text': 'Khie', 'linkUri': 'https://line.me/ti/p/~aoy1433.'}, contentType=19)
               if text.lower() == 'help2':
                    icon = "http://dl.profile.line.naver.jp/"+lineProfile.pictureStatus
                    name = "คำสั่งบอท"                   
                    link = "http://line.me/ti/p/~aoy1433."
                    myHelp2 = myhelp2()
                    line.sendFooter(to, str(myHelp2),link ,icon,name)
                    line.sendMentionFooter(to, '「ผู้ควบคุมบอท」\n', sender, "https://line.me/ti/p/~aoy1433.", "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, line.getContact(sender).displayName);line.sendMessage(to, line.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+line.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~aoy1433.', 'type': 'mt', 'subText': "AOYBOTLINE", 'a-installUrl': 'https://line.me/ti/p/~aoy1433.', 'a-installUrl': ' https://line.me/ti/p/~aoy1433.', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~aoy1433.', 'i-linkUri': 'https://line.me/ti/p/~aoy1433.', 'id': 'mt000000000a6b79f9', 'text': 'Khie', 'linkUri': 'https://line.me/ti/p/~aoy1433.'}, contentType=19)
...
#==============================================================================#
                    ...
                    line.sendMessage(to, "〘บอททำงานอยู่100%〙")
...
#==============================================================================#
                    ...
                    line.sendMessage(to, "     [ Add ᴏɴ ]\n\nออโต้แอดเปิดใช้งานเรียบร้อยแล้ว🔰\n🄰🄾🅈🄱🄾🅃🄻🄸🄽🄴", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
                    ...
                    line.sendMessage(to, "KickContact ✘\🄰🄾🅈🄱🄾🅃🄻🄸🄽🄴n", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
#==============================================================================#
                   ...
                   # line.sendImageWithURL(msg.to, cover)
                    ...
                    line.sendMentionFooter(to, '「ผู้สร้างบอท」\n', sender, "https://line.me/ti/p/~aoy1433.", "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, line.getContact(sender).displayName);line.sendMessage(to, line.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+line.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~aoy1433.', 'type': 'mt', 'subText': "AOYBOTLINE", 'a-installUrl': 'https://line.me/ti/p/~aoy1433.', 'a-installUrl': ' https://line.me/ti/p/~samuri5.', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~aoy1433.', 'i-linkUri': 'https://line.me/ti/p/~aoy1433.', 'id': 'mt000000000a6b79f9', 'text': 'Khie', 'linkUri': 'https://line.me/ti/p/~aoy1433.'}, contentType=19)
                    ...
                    line.sendMusic(to, line.getContact(sender).displayName, "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, str(userid), "AOYBOTLINE", line.getContact(sender).displayName)
...
#==============================================================================#
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                               ...
                               mi_d = Mids[:33]
                               line.createGroup("🄰🄾🅈🄱🄾🅃🄻🄸🄽🄴",mi_d)
                               line.sendText(msg.to,"🏂⛷️งิงิ")
                               line.createGroup("🄰🄾🅈🄱🄾🅃🄻🄸🄽🄴",mi_d)
                               line.sendText(msg.to,"🏂⛷️งิงิ")
                               line.sendText(msg.to,"เรียบร้อยงิงิ")
                            except:
                                pass
                    print ("[Command]covergroup]")
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                           ...
                           line.sendText(g.mid,"💕รักนะ💕")
                           line.sendText(g.mid,"💕รักนะ💕")
                           line.sendText(msg.to, "💕บอกรักเรียบร้อยแล้วนะ💕")
                           print (" Spammed !")
                    ...
                    mi_d = Mids[:33]
                    line.createGroup("🄰🄾🅈🄱🄾🅃🄻🄸🄽🄴", mi_d)
                    line.sendText(msg.to,"welcome to room 🄰🄾🅈🄱🄾🅃🄻🄸🄽🄴")
                                    ...
                                    if msg.toType == 2:
                                        ...
                                        for i in range(k+1):
                                            for j in gMembMids[i*30 : (i+1)*30]:
                                                ...
                                                num = num+1
                                            line.sendMessage(receiver,"รอสักครู่🕛เดียวยกต่อ\n 🄰🄾🅈🄱🄾🅃🄻🄸🄽🄴 ")
...
#=============COMMAND KICKER===========================#
                ...
                elif "กุ๊กกุ๊ก!" in msg.text:
                	if msg.toType == 2:
                         _name = msg.text.replace("กุ๊กกุ๊ก!","")
                         gs = line.getGroup(receiver)
                         line.sendMessage(receiver,"สวัสดีพวกไก่🐓🐔")
                         targets = []
                         for g in gs.members:
...
#=============COMMAND PROTECT=========================#
                    ...
                    if RfuProtect["Protectguest"] == False:
                        if settings["lang"] == "JP":
                            line.sendMessage(msg.to,"ปิดป้องกันกลุ่มl", contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
                        else:
                    ...
                    if "/ti/g/" in msg.text.lower():
                        if settings["autoJoinTicket"] == True:
                            ...
                            for ticket_id in n_links:
                                ...
                                line.sendMessage(to, "🔰Join🔰\n🔀👉 %s 👈" % str(group.name), contentMetadata = {'AGENT_ICON': 'http://dl.profile.line-cdn.net/'+line.getContact(lineMID).pictureStatus, 'AGENT_NAME': 'Creator', 'AGENT_LINK': 'https://line.me/ti/p/Rvv5zHBLDO'})
...
#===========ชุด API คำสั่งใช้งานบอทสิริเชนวี10 ========================== 
        if op.type == 26:
            ...
            if settings ["Aip"] == True:
                if msg.text in ["ควย","หี","แตด","เย็ดแม่","เย็ดเข้","ควาย","สัส","เหี้ย","ไอ้เหี้ย","พ่อมึงตาย","ไอ้เลว","ระยำ","ชาติหมา","หน้าหี","เซลกาก","ไอ้เรส","ไอ้เหี้ยเรส","ไอ่เรส","พ่องตาย","ส้นตีน","แม่มึงอ่ะ","แม่มึงดิ","พ่อมึงดิ"]:
                    line.kickoutFromGroup(receiver,[sender])
...
#                    line.sendMessage(msg.to, None, contentMetadata={"STKID":"51626516","STKPKGID":"11538","STKVER":"1"}, contentType=7)
            if settings ["Api"] == True:
                if msg.text in ["แตก","เช็คบอท","เทส","แตก1"]:
...
#                    line.sendText(msg.to,"สวัสดีครับ ผมชื่อตาต้อมนะ ยินดีที่ได้รู้จัก")
            if settings ["Api"] == True:
                if msg.text in ["/ตั้งเวลา","..แทค"]:
                    line.sendText(msg.to,"🔷ตรวจพบคำสั่งแทคขออนุญาติแทคทุกคนนะคับ🔷")
...
#                    line.sendText(msg.to,".อ่าน") 
        ...
        if op.type ==25:
            ...
            if settings ["Api"] == True:
                if msg.text in [".เปิดเชิญ","ใอนุญาติเชิญ"]:
