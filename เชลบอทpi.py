...
settings = {
    ...
    "timeRestart": "18000",
    "message1":"Armtheking.🇹🇭",
    "message":"บัญชีนี้ถูกป้องกันโดย Armtheking.🇹🇭 ระบบได้ทำการบล็อคคุณอัตโนมัติเนื่องจากคุณยังไม่ได้ยืนยันตัวตนกับผู้สร้างบอท\nสามารถยืนตัวตนได้ง่ายโดยการพิม unblockกับArmtheking.🇹🇭ระบบจะทำการปลดบล็อคท่านโดยอัตโนมัต",
    "comment":"""Armtheking.🇹🇭""",
    "userAgent": [
 ...
 *หมายเหตุ*  คำสั่งที่เป็นภาษาไทย
 ให้ใส่ . นำหน้าคำสั่งเวลาใช้ด้วยนะครับ"""
    return myHelp
...
#==============================================================================#
                ...
                if text.lower() == 'คำสั่ง':
                    ...
                    line.sendMentionFooter(to, '「ผู้สร้างบอท」\n', sender, "https://line.me/ti/p/~ris112233", "http://dl.profile.line-cdn.net/"+line.getContact(sender).pictureStatus, line.getContact(sender).displayName);line.sendMessage(to, line.getContact(sender).displayName, contentMetadata = {'previewUrl': 'http://dl.profile.line-cdn.net/'+line.getContact(sender).pictureStatus, 'i-installUrl': 'https://line.me/ti/p/~ris112233', 'type': 'mt', 'subText': "❈͜͡✯ѕειт вот чєєωα✯͜͡❈", 'a-installUrl': 'https://line.me/ti/p/~ris112233', 'a-installUrl': ' https://line.me/ti/p/~ris112233', 'a-packageName': 'com.spotify.music', 'countryCode': 'ID', 'a-linkUri': 'https://line.me/ti/p/~ris112233', 'i-linkUri': 'https://line.me/ti/p/~ris112233', 'id': 'mt000000000a6b79f9', 'text': 'Khie', 'linkUri': 'https://line.me/ti/p/~ris112233'}, contentType=19)
...
#==============================================================================#
                    ...
                    try:
                        arr = []
                        owner = "ua49812ff475e1f2b0d58e34abe52e0c1"
...
#==============================================================================#
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "ufb6d6e2e1849c403d55f4ba3071985a2")
...
#==============================================================================#
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                               ...
                               mi_d = Mids[:33]
                               line.createGroup("ѕειт вот чєєωα",mi_d)
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                           line.sendText(g.mid,"❈͜͡✯ѕειт вот чєєωα✯͜͡❈")
                           line.sendText(g.mid,"❈͜͡✯ѕειт вот чєєωα✯͜͡❈")
                           line.sendText(g.mid,"❈͜͡✯ѕειт вот чєєωα✯͜͡❈")
                           line.sendText(g.mid,"❈͜͡✯ѕειт вот чєєωα✯͜͡❈")
                           line.sendText(g.mid,"❈͜͡✯ѕειт вот чєєωα✯͜͡❈")
...
#==============================================================================#
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         line.sendMessage(msg.to, "❈͜͡✯ѕειт вот чєєωα✯͜͡❈\n👇ตั้งข้อความตอบโต้เมื่อมีคนแอดแล้ว ดังนี้👇\n\n👉{}".format(str(spl)))
                                    ...
                                    if msg.toType == 2:
                                        ...
                                        for i in range(k+1):
                                            for j in gMembMids[i*30 : (i+1)*30]:
                                                ...
                                                num = num+1
                                            line.sendMessage(receiver,"รอสักครู่🕛 แล้วจะทำการ ยกต่อ 30 คน\n ❈͜͡✯ѕειт вот чєєωα✯͜͡❈ ")
...
#                    	line.sendMessage(msg.to, str(settings["comment"]))
                if settings["Api"] == True:
                    if msg.text in ["เชลใคร"]:
                        line.sendText(msg.to,"❈͜͡✯ѕειт вот чєєωα✯͜͡❈")
                if settings["Api"] == True:
                    if msg.text in ["อย","อยู่ไหม"]:
